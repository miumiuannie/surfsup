...
def welcome():
    ...
    return (
        ...
        f"/api/v1.0/tobs<br/>"
        f"/api/v1.0/2017-06-01<br/>"
        f"/api/v1.0/2017-06-01/2017-06-07"
    )
...
def start(start=None):
    ...
    # Docstring
    """Return a list of tmin, tmax, tavg for the dates greater than or equal to the date provided"""
...
def start_end(start=None, end=None):
    # Docstring
    """Return a list of tmin, tmax, tavg for the dates in range of start date and end date inclusive"""
